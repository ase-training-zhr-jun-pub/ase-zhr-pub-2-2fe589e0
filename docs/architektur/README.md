...
- [ADR-001: Technologie-Stack für den Booking-Service](adrs/ADR-001-technologie-stack-fuer-booking-service.md)
  — Swift / Vapor mit SQLite. **Abgelöst durch ADR-004.**
...
- [ADR-004: FastAPI statt Swift/Vapor für den Booking-Service](adrs/ADR-004-fastapi-statt-vapor-im-prototyp.md)
  — Python / FastAPI wegen langer Vapor-Cold-Build-Zeiten; löst ADR-001 ab.
